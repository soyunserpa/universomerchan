        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-surface-200 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                <label className="text-sm font-semibold mb-1.5 block">País *</label>
              ...
              {state.items.map((item, i) => (
                <div key={i} className="flex gap-3">
                  <div className="w-12 h-12 rounded-lg bg-surface-50 flex items-center justify-center overflow-hidden flex-shrink-0">
                    {item.customization?.mockupUrl || item.productImage ? <img src={item.customization?.mockupUrl || item.productImage} alt={item.productName || "Producto"} className="w-[80%] h-[80%] object-contain" /> : <Gift size={14} className="text-gray-300" />}
                  </div>
